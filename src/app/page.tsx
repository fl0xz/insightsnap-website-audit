...
export default function Home() {
  ...
  const runAudit = async (url: string) => {
    ...
    try {
      // In the demo version, we'll just simulate an API call
          ...
          {!results ? (
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <div className="mt-6 text-center">
                <a 
                  href="/loggedintest" 
                  className="inline-flex items-center py-2.5 px-6 bg-[#5D3FD3] hover:bg-[#4c34a9] text-white font-medium rounded-lg transition-colors"
                >
                  View Logged-In Version Demo
                </a>
              </div>
            </div>
          )}
